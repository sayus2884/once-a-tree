    ...
    <div>
      <div className="grid">
        <section className="grid lg:grid-cols-2 lg:rtl">
          ...
          <div className="grid gap-8 sm:gap-12 bg-ocean-500 text-white page-px py-10 sm:py-20 ltr">
            <div>
          ...
          <p className="page-px py-10 sm:py-20 lg:hidden lg:bottom-0 bg-white lg:shadow">
            For over 40 Years, Once A Tree Furniture has been committed to creating unique, livable
            spaces that are designed with you in mind. Your experience is what matters and we
            understand that even the smallest of details need to be considered. We are committed to
            innovating our products, developing relationships, and pushing the boundaries of what it
            means to be a full-service brand. We are dedicated to making your vision come to life.
          </p>
        </section>
        ...
        <section className="grid lg:grid-cols-2">
          ...
          <div className="grid gap-8 sm:gap-12 page-px py-10 sm:py-20">
            <h2 className="title">Custom Built in Vancouver</h2>
            <p>
        ...
        <section className="grid lg:grid-cols-2">
          ...
          <div className="grid gap-8 sm:gap-12 page-px py-10 sm:py-20">
            <h2 className="title">Let&apos;s Build Your Custom Furniture</h2>
            <p>
